...
class Attack:
    def __init__(self, sess, restore_path, audio, impulse, phrase, freq_min, freq_max, batch_size, learning_rate, weight_decay):
        ...
        #
        # gradients,var= optimizer.compute_gradients(self.ctcloss, [self.delta])[0]
        # self.train = optimizer.apply_gradients([(tf.sign(gradients), var)])
    ...
    def attack(self, outdir, num_iterations=5000):
        ...
        for itr in range(num_iterations + 1):
            ...
            decoded, logits, ctcloss, ae_transformed, ae_input, delta_filtered,= sess.run([self.decoded, self.logits, self.ctcloss, self.ae_transformed, self.ae_input, self.delta_filtered], {self.imp_indices: indice})
            ...
            if itr % 10 == 0:
                ...
                matched = list(filter(lambda index: res[index] == ''.join([toks[x] for x in self.phrase]), range(self.batch_size)))
...
def main():
    ...
    parser.add_argument('--lr', type=float, required=False, default=100,
    ...
    with tf.Session() as sess:
        ...
        irs = []
        # impulse = ['impulse/air_binaural_aula_carolina_0_1_3_135_3.wav',
        #            'impulse/air_binaural_aula_carolina_0_1_3_180_3.wav',
        #            'impulse/air_binaural_aula_carolina_0_1_4_90_3.wav',
        #            'impulse/air_binaural_aula_carolina_0_1_7_90_3.wav',
        #            'impulse/air_binaural_aula_carolina_1_1_1_90_3.wav',
        #            'impulse/air_binaural_aula_carolina_1_1_2_90_3.wav',
        #            'impulse/air_binaural_aula_carolina_1_1_3_0_3.wav', 'impulse/air_binaural_booth_0_0_1.wav',
        #            'impulse/air_binaural_booth_0_0_2.wav', 'impulse/air_binaural_booth_0_0_3.wav',
        #            'impulse/air_binaural_booth_0_1_1.wav', 'impulse/air_binaural_booth_0_1_2.wav',
        #            'impulse/air_binaural_booth_0_1_3.wav', 'impulse/air_binaural_booth_1_0_1.wav',
        #            'impulse/air_binaural_lecture_0_1_1.wav', 'impulse/air_binaural_lecture_0_1_2.wav',
        #            'impulse/air_binaural_lecture_0_1_3.wav', 'impulse/air_binaural_lecture_0_1_4.wav',
        #            'impulse/air_binaural_lecture_0_1_5.wav', 'impulse/air_binaural_lecture_0_1_6.wav',
        #            'impulse/air_binaural_lecture_1_0_1.wav', 'impulse/air_binaural_lecture_1_0_2.wav',
        #            'impulse/air_binaural_lecture_1_0_3.wav', 'impulse/air_binaural_lecture_1_0_4.wav',
        #            'impulse/air_binaural_lecture_1_0_5.wav', 'impulse/air_binaural_lecture_1_0_6.wav',
        #            'impulse/air_binaural_lecture_1_1_1.wav', 'impulse/air_binaural_lecture_1_1_2.wav',
        #            'impulse/air_binaural_lecture_1_1_3.wav', 'impulse/air_binaural_lecture_1_1_4.wav',
        #            'impulse/air_binaural_lecture_1_1_5.wav', 'impulse/air_binaural_meeting_0_0_1.wav',
        #            'impulse/air_binaural_meeting_0_0_2.wav', 'impulse/air_binaural_meeting_0_0_3.wav',
        #            'impulse/air_binaural_meeting_0_0_4.wav', 'impulse/air_binaural_meeting_0_0_5.wav',
        #            'impulse/air_binaural_meeting_0_1_1.wav', 'impulse/air_binaural_meeting_0_1_2.wav',
        #            'impulse/air_binaural_meeting_0_1_3.wav', 'impulse/air_binaural_meeting_0_1_4.wav',
        #            'impulse/air_binaural_meeting_0_1_5.wav', 'impulse/air_binaural_meeting_1_0_1.wav',
        #            'impulse/air_binaural_meeting_1_0_2.wav', 'impulse/air_binaural_meeting_1_0_3.wav',
        #            'impulse/air_binaural_meeting_1_0_4.wav', 'impulse/air_binaural_meeting_1_0_5.wav',
        #            'impulse/air_binaural_meeting_1_1_1.wav', 'impulse/air_binaural_meeting_1_1_2.wav',
        #            'impulse/air_binaural_office_0_0_1.wav', 'impulse/air_binaural_office_0_0_2.wav',
        #            'impulse/air_binaural_office_0_0_3.wav', 'impulse/air_binaural_office_0_1_1.wav',
        #            'impulse/air_binaural_office_0_1_2.wav', 'impulse/air_binaural_office_0_1_3.wav',
        #            'impulse/air_binaural_office_1_0_1.wav', 'impulse/air_binaural_office_1_0_2.wav',
        #            'impulse/air_binaural_office_1_0_3.wav', 'impulse/air_binaural_office_1_1_1.wav',
        #            'impulse/air_binaural_office_1_1_2.wav', 'impulse/air_binaural_office_1_1_3.wav',
        #            'impulse/air_binaural_stairway_0_1_1_105.wav', 'impulse/air_binaural_stairway_0_1_1_120.wav',
        #            'impulse/air_binaural_stairway_0_1_1_135.wav', 'impulse/air_binaural_stairway_0_1_1_150.wav',
        #            'impulse/air_binaural_stairway_0_1_1_15.wav', 'impulse/air_binaural_stairway_0_1_1_30.wav',
        #            'impulse/air_binaural_stairway_0_1_1_45.wav', 'impulse/air_binaural_stairway_0_1_1_60.wav',
        #            'impulse/air_binaural_stairway_0_1_1_75.wav', 'impulse/air_binaural_stairway_0_1_1_90.wav',
        #            'impulse/air_phone_lecture1_hfrp_0.wav', 'impulse/air_phone_lecture1_hfrp_1.wav',
        #            'impulse/air_phone_lecture_hfrp_0.wav', 'impulse/air_phone_lecture_hfrp_1.wav',
        #            'impulse/air_phone_lecture_hhp_0.wav', 'impulse/air_phone_lecture_hhp_1.wav',
        #            'impulse/air_phone_office_hfrp_0.wav', 'impulse/air_phone_office_hfrp_1.wav',
        #            'impulse/air_phone_office_hhp_0.wav', 'impulse/air_phone_office_hhp_1.wav']
